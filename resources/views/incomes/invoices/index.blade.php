        ...
        <table class="table table-bordered table-striped table-hover" id="tbl-invoices">
          ...
          @foreach($invoices as $item)
            <tr>
              ...
              <td>
                <a href="{{ url('incomes/invoices/' . $item->id) }}" class="btn btn-info btn-xs"><i class="fa fa-eye"
                                                                                                    aria-hidden="true"></i> {{ trans('general.show') }}
                </a>
                <a href="{{ url('incomes/invoices/' . $item->id . '/edit') }}" class="btn btn-primary btn-xs"><i
